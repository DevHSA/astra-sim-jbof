...
class MemoryType(Enum):
    ...
    # MemoryLocationType enum in astra-sim/astra-sim/system/AstraMemoryAPI.hh.
    FLASH_MEMORY = 5
    JBOF_MEMORY = 6
    COLDSTORE_MEMORY = 7
...
class LLMConverter:
    ...
    def get_mem_type(self, mem_type: str) -> int:
        ...
        if mem_type == "LOCAL":
            ...
            return MemoryType.FLASH_MEMORY.value
        elif mem_type == "JBOF":
            return MemoryType.JBOF_MEMORY.value
        elif mem_type == "COLDSTORE":
            return MemoryType.COLDSTORE_MEMORY.value
